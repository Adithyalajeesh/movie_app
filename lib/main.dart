...
import 'package:imdb_clone/utils/text.dart';
import 'package:imdb_clone/widgets/toprated.dart';
import 'package:imdb_clone/widgets/trending.dart';
import 'package:imdb_clone/widgets/tv.dart';
...
class _HomeState extends State<Home> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
          title: modified_text(text: ' Movie App ❤', color: Colors.white, size: 24,),
